#!/bin/bash
#
# Batch Inference Submission Script for DNABERT-2
#
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        --help|-h)
            ...
            echo "  --max_length N       Maximum sequence length (default: 512)"
...
echo "============================================================"
echo "DNABERT-2 Batch Inference Submission"
echo "============================================================"
...
while IFS= read -r INPUT_CSV || [ -n "${INPUT_CSV}" ]; do
    ...
    # Submit SLURM job
    JOB_ID=$(sbatch \
        --job-name="dnabert2_inf_${INPUT_BASENAME}" \
