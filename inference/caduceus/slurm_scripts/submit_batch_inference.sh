#!/bin/bash
#
# Batch Inference Submission Script for Caduceus
#
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        --help|-h)
            ...
            echo "  --checkpoint FILE    Path to fine-tuned Caduceus checkpoint (.ckpt)"
            echo "  --config FILE        Path to Caduceus config JSON file"
            echo ""
            echo "Optional arguments:"
            echo "  --batch_size N       Batch size for inference (default: 32)"
            echo "  --max_length N       Maximum sequence length (default: 1024)"
            echo "  --d_output N         Number of output classes (default: 2)"
            echo "  --threshold F        Classification threshold (default: 0.5)"
            echo "  --no_conjoin         Disable reverse complement conjoining"
...
echo "============================================================"
echo "Caduceus Batch Inference Submission"
echo "============================================================"
